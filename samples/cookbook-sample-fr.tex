...
\registerTagIcon{Végétarien}{emoji}{seedling}
\registerTagIcon{Épicé}{emoji}{hot-pepper}
\registerTagIcon{Sans Gluten}{text}{GF}
\registerTagIcon{Sans Lactose}{text}{DF}
\registerTagIcon{Végétalien}{text}{V}
...
\recipe{%
	...
	ingredients = {
			\ingredient{bananes}[2][][moyennes à grandes bien mûres\note{Plus les bananes sont mûres, plus les pancakes seront sucrés. Recherchez des bananes avec des taches brunes sur la peau.}]
			\ingredient{gros œufs}[4]
			\ingredient{farine de blé complet ou de sarrasin ou 2/3 tasse de farine d'avoine\note{Pour une option sans gluten, utilisez de la farine de sarrasin ou d'avoine. La texture sera légèrement différente mais tout aussi délicieuse.}}[1/2][tasse]
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{gros œufs}[4]
			\ingredient{lait entier}[1][tasse]
			\ingredient{sucre blanc}[2][c. à soupe]
			\ingredient{extrait de vanille}[1][c. à café]
			\ingredient{cannelle moulue}[1][c. à café]
			\ingredient{muscade moulue}[1/4][c. à café]
			\ingredient{Une pincée de sel}

			\ingredientsection{Cuisson et Service}
			\ingredient{tranches épaisses de pain (brioche, challah ou pain blanc)\note{Le pain de la veille fonctionne mieux car il absorbe le mélange de crème sans se désagréger. Le pain brioché ou challah crée le pain perdu le plus luxueux, mais n'importe quel pain tranché épais fera l'affaire.}}[8]
			\ingredient{beurre}[2-3][c. à soupe][pour la cuisson]
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{grosses tomates mûres}[4][][coupées en dés\note{Utilisez les tomates les plus mûres et les plus savoureuses que vous puissiez trouver. Les variétés anciennes ou mûries sur pied fonctionnent à merveille.}]
			\ingredient{gousses d'ail}[3][][hachées]
			\ingredient{feuilles de basilic frais}[1/4][tasse][hachées]
			\ingredient{huile d'olive extra vierge}[2][c. à soupe]
			\ingredient{vinaigre balsamique}[1][c. à soupe]
			\ingredient{Sel et poivre noir}[][][au goût]

			\ingredientsection{Pain}
			\ingredient{baguette française}[1][][tranchée en diagonale\note{Une baguette de la veille fonctionne mieux pour la bruschetta car elle grille plus uniformément et a une meilleure texture.}]
			\ingredient{huile d'olive}[2][c. à soupe]
			\ingredient{gousse d'ail}[1][][coupée en deux]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{gousses d'ail}[2][][hachées]
			\ingredient{filets d'anchois}[2][][hachés]
			\ingredient{jus de citron frais}[2][c. à soupe]
			\ingredient{moutarde de Dijon}[1][c. à café]
			\ingredient{sauce Worcestershire}[1][c. à café]
			\ingredient{mayonnaise}[1][tasse]
			\ingredient{parmesan fraîchement râpé\note{Pour la meilleure saveur, utilisez du parmesan fraîchement râpé. La vinaigrette peut être préparée jusqu'à 3 jours à l'avance et conservée au réfrigérateur.}}[1/2][tasse]
			\ingredient{Sel et poivre noir}

			\ingredientsection{Salade}
			\ingredient{grosses têtes de laitue romaine}[2][][hachées]
			\ingredient{croûtons maison ou du commerce}[1][tasse]
			\ingredient{copeaux de parmesan}[1/2][tasse]
...
\recipe{%
	...
	ingredients = {
			\ingredient{grosses tomates mûres}[4][][tranchées de 6 mm d'épaisseur\note{Utilisez les meilleures tomates que vous pouvez trouver—les variétés anciennes ou mûries sur pied fonctionnent à merveille.}]
			\ingredient{fromage mozzarella frais}[450][g][tranché de 6 mm d'épaisseur\note{La mozzarella di bufala fraîche est traditionnelle et fortement recommandée pour la saveur la plus authentique.}]
			\ingredient{feuilles de basilic frais}[1][tasse]
			\ingredient{huile d'olive extra vierge}[3][c. à soupe]
			\ingredient{vinaigre balsamique ou glaçage}[2][c. à soupe]
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{ailes de poulet}[1,4][kg][séparées aux articulations, bouts retirés\note{Pour des ailes extra croustillantes, séchez-les complètement avant l'assaisonnement. Servir avec des bâtonnets de céleri et une vinaigrette au fromage bleu ou ranch.}]
			\ingredient{bicarbonate de soude}[1][c. à soupe]
			\ingredient{sel}[1][c. à café]
			\ingredient{poudre d'ail}[1][c. à café]
			\ingredient{poivre noir}[1/2][c. à café]

			\ingredientsection{Sauce Buffalo}
			\ingredient{sauce piquante (Frank's RedHot de préférence)}[1/2][tasse]
			\ingredient{beurre non salé}[1/3][tasse][fondu]
			\ingredient{vinaigre blanc}[1][c. à soupe]
			\ingredient{sauce Worcestershire}[1/4][c. à café]
			\ingredient{poivre de Cayenne}[1/4][c. à café][(optionnel, pour plus de piquant)]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{huile d'olive}[1][c. à soupe]
			\ingredient{beurre}[20][g]
			\ingredient{oignons bruns}[2][][coupés en deux, finement hachés]
			\ingredient{gousses d'ail}[2][][écrasées]
			\ingredient{viande de bœuf hachée}[500][g]
			\ingredient{pâte de tomate (1/2 tasse)}[145][g]
			\ingredient{vin rouge sec (1 tasse)}[250][mL]
			\ingredient{boîtes de tomates en dés}[2][x 400g]
			\ingredient{origan séché}[1][c. à soupe]
			\ingredient{feuilles de laurier séchées}[3]
			\ingredient{Sel et poivre noir fraîchement moulu}
			\ingredient{persil frais}[1/3][tasse][légèrement tassé, grossièrement haché]

			\ingredientsection{Service}
			\ingredient{spaghetti fins séchés}[375][g]
			\ingredient{parmesan}[80][g][pour servir]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{huile d'olive}[1/4][tasse]
			\ingredient{jus de citron frais}[3][c. à soupe]
			\ingredient{gousses d'ail}[2][][hachées]
			\ingredient{aneth frais}[1][c. à soupe][haché]
			\ingredient{persil frais}[1][c. à soupe][haché]
			\ingredient{zeste de citron}[1][c. à café]
			\ingredient{Sel et poivre}

			\ingredientsection{Saumon}
			\ingredient{filets de saumon (170g chacun)\note{Pour de meilleurs résultats, utilisez des filets d'épaisseur uniforme afin qu'ils cuisent uniformément.}}[4]
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{huile de coco}[2][c. à soupe]
			\ingredient{pâte de curry rouge thaï\note{La pâte de curry rouge thaï varie en niveau de piquant selon les marques. Commencez avec moins et ajoutez-en au goût.}}[3-4][c. à soupe]
			\ingredient{lait de coco (400 mL)}[1][boîte]
			\ingredient{bouillon de légumes}[1][tasse]
			\ingredient{sauce soja ou tamari}[2][c. à soupe]
			\ingredient{sucre brun ou sirop d'érable}[1][c. à soupe]
			\ingredient{poivrons}[2][][tranchés]
			\ingredient{aubergine moyenne}[1][][coupée en cubes]
			\ingredient{haricots verts}[1][tasse][parés]
			\ingredient{pousses de bambou}[1][tasse]
			\ingredient{feuilles de basilic thaï}[1][tasse]
...
\recipe{%
	...
	equipment = {Moules à gâteau ronds de 23 cm},
	ingredients = {
			\ingredientsection{Gâteau}
			\ingredient{farine tout usage}[2][tasses]
			\ingredient{sucre blanc}[2][tasses]
			\ingredient{poudre de cacao non sucrée}[3/4][tasse]
			\ingredient{bicarbonate de soude}[2][c. à café]
			\ingredient{levure chimique}[1][c. à café]
			\ingredient{sel}[1][c. à café]
			\ingredient{gros œufs\note{Pour de meilleurs résultats, amenez tous les ingrédients à température ambiante avant de commencer.}}[2]
			\ingredient{babeurre}[1][tasse]
			\ingredient{café noir fort}[1][tasse][chaud]
			\ingredient{huile végétale}[1/2][tasse]
			\ingredient{extrait de vanille}[2][c. à café]

			\ingredientsection{Glaçage}
			\ingredient{beurre non salé (2 bâtonnets)}[1][tasse][ramolli\note{Les couches de gâteau peuvent être préparées la veille, enveloppées dans du film plastique et conservées à température ambiante.}]
			\ingredient{sucre glace}[3 1/2][tasses]
			\ingredient{poudre de cacao non sucrée}[1/2][tasse]
			\ingredient{crème épaisse}[1/2][tasse]
			\ingredient{extrait de vanille}[2][c. à café]
			\ingredient{sel}[1/4][c. à café]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{gros jaunes d'œufs}[6]
			\ingredient{sucre blanc}[3/4][tasse]
			\ingredient{fromage mascarpone}[1 1/3][tasse][à température ambiante]
			\ingredient{crème épaisse}[2][tasses][froide]

			\ingredientsection{Couche de Café}
			\ingredient{espresso fort ou de café}[2][tasses][refroidi\note{Utilisez un espresso ou un café fort de haute qualité pour la meilleure saveur.}]
			\ingredient{liqueur de café}[3][c. à soupe][(optionnel)]
			\ingredient{biscuits à la cuillère (savoiardi)}[40-48]

			\ingredientsection{Garniture}
			\ingredient{poudre de cacao non sucrée}[2][c. à soupe]
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{farine tout usage}[2 1/2][tasses]
			\ingredient{sel}[1][c. à café]
			\ingredient{sucre blanc}[1][c. à soupe]
			\ingredient{beurre non salé froid (2 bâtonnets)}[1][tasse][coupé en cubes\note{Pour une croûte ultra feuilletée, assurez-vous que tous les ingrédients sont froids et manipulez la pâte le moins possible.}]
			\ingredient{eau glacée}[6-8][c. à soupe]

			\ingredientsection{Garniture aux Pommes}
			\ingredient{pommes tranchées (mélange de Granny Smith et Honeycrisp)}[6-7][tasses]
			\ingredient{sucre blanc}[2/3][tasse]
			\ingredient{farine tout usage}[1/4][tasse]
			\ingredient{cannelle moulue}[1][c. à café]
			\ingredient{muscade moulue}[1/4][c. à café]
			\ingredient{sel}[1/4][c. à café]
			\ingredient{jus de citron}[2][c. à soupe]
			\ingredient{beurre}[2][c. à soupe][coupé en petits morceaux]

			\ingredientsection{Garniture}
			\ingredient{œuf}[1][][battu (pour dorure)]
			\ingredient{sucre cristallisé}[1][c. à soupe]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			\ingredient{farine tout usage}[2 1/4][tasses]
			\ingredient{bicarbonate de soude}[1][c. à café]
			\ingredient{sel}[1][c. à café]
			\ingredient{beurre (2 bâtons)}[1][tasse][ramolli]
			\ingredient{sucre blanc}[3/4][tasse]
			\ingredient{cassonade}[3/4][tasse][tassée]
			\ingredient{gros œufs}[2]
			\ingredient{extrait de vanille}[2][c. à café]
			\ingredient{pépites de chocolat}[2][tasses]
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
			\ingredient{jus de citron frais (environ 6-8 citrons)}[1][tasse]
			\ingredient{sucre blanc}[1][tasse]
			\ingredient{eau froide}[5][tasses]
			\ingredient{Glaçons}
