...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{4}[][large ripe tomatoes\note{Use the ripest, most flavorful tomatoes you can find. Heirloom or vine-ripened varieties work beautifully.}][diced]
		...
		\ingredient{1}[][French baguette\note{A day-old baguette works best for bruschetta as it toasts more evenly and has better texture.}][sliced diagonally]
...
\recipe{%
	...
	vegetarian = {yes},
	ingredients = {
		\ingredient{4}[][large ripe tomatoes\note{Use the best quality tomatoes you can find—heirloom or vine-ripened varieties work beautifully.}][sliced 1/4 inch thick]
		\ingredient{16}[oz][fresh mozzarella cheese\note{Fresh mozzarella di bufala is traditional and highly recommended for the most authentic flavor.}][sliced 1/4 inch thick]
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{3}[lbs][chicken wings\note{For extra crispy wings, pat them completely dry before seasoning. Serve with celery sticks and blue cheese or ranch dressing.}][separated at joints, tips removed]
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{145}[g][tomato paste (1/2 cup)]
		\ingredient{250}[mL][dry red wine (1 cup)]
		...
		\ingredient{375}[g][dried thin spaghetti]
		\ingredient{80}[g][parmesan][to serve]
	},
	instructions ={
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{1}[can][coconut milk (14 oz)]
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{1}[cup][unsalted butter (2 sticks)\note{The cake layers can be made a day ahead, wrapped in plastic wrap, and stored at room temperature.}][softened]
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{2}[cups][strong espresso or coffee\note{Use high-quality espresso or strong coffee for the best flavor.}][cooled]
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{1}[cup][cold unsalted butter (2 sticks)\note{For the flakiest crust, make sure all ingredients are cold and handle the dough as little as possible.}][cubed]
